...
\@x{}\moduleLeftDash\@xx{ {\MODULE} paxos}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ Maximum ( S ) \.{\defeq}}%
...
\@x{\@s{8.2}}%
\@y{\@s{0}%
 Essentially takes the maximum in the set \ensuremath{S
}}%
\@xx{}%
...
\@x{\@s{8.2} \.{\IN} Max [ S ]}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} RM ,\, Acceptor ,\, Majority ,\, Ballot}%
\@pvspace{24.0pt}%
\@x{ {\ASSUME}}%
...
\@x{\@s{15.07} \.{\cup}}%
 ...
 Ballot ,\, bal \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\, val \.{:}
 \{\@w{prepared} ,\,\@w{aborted} ,\,\@w{none} \} ,\, acc \.{:} Acceptor ]}%
\@x{\@s{15.07} \.{\cup}}%
 \@x{\@s{8.2} [ type \.{:} \{\@w{phase2a} \} ,\, ins \.{:} RM ,\, bal \.{:}
 Ballot ,\, val \.{:} \{\@w{prepared} ,\,\@w{aborted} ,\,\@w{none} \} ]}%
\@x{\@s{15.07} \.{\cup}}%
 \@x{\@s{8.2} [ type \.{:} \{\@w{phase2b} \} ,\, acc \.{:} Acceptor ,\, ins
 \.{:} RM ,\, bal \.{:} Ballot ,\, val \.{:} \{\@w{prepared} ,\,\@w{aborted}
 \} ]}%
\@x{\@s{15.07} \.{\cup}}%
\@x{\@s{8.2} [ type \.{:} \{\@w{Commit} ,\,\@w{Abort} \} ]}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} rmState ,\, aState ,\, msgs}%
\@pvspace{8.0pt}%
\@x{ PCTypeOk \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} rmState \.{\in} [ RM \.{\rightarrow} \{\@w{working}
 ,\,\@w{prepared} ,\,\@w{committed} ,\,\@w{aborted} \} ]}%
 \@x{\@s{8.2} \.{\land} aState \.{\in} [ RM \.{\rightarrow} [ Acceptor
 \.{\rightarrow} [ mbal \.{:} Ballot ,\,}%
\@x{\@s{153.58} bal\@s{4.61} \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\,}%
 \@x{\@s{153.58} val\@s{4.10} \.{:} \{\@w{prepared} ,\,\@w{aborted}
 ,\,\@w{none} \} ] ] ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 24 19:56:23 \ensuremath{AEST} 2021 by \ensuremath{Isitha}
 \ensuremath{Subasinghe
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Jun} 24
 19:28:01 \ensuremath{AEST} 2021 by \ensuremath{Isitha} \ensuremath{Subasinghe
}%
\end{cpar}%
\end{lcom}%
\end{document}
